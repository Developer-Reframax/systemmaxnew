...
export async function GET(request: NextRequest) {
  ...
  // Valida JWT do app (mesmo fluxo das rotas protegidas) usando o token na query
  ...
  const channel = client.channel('desvios-monitoramento')

  channel.on(
    'postgres_changes',
    { event: '*', schema: 'public', table: 'desvios' },
