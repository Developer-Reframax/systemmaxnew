...
export async function GET(
  ...
  try {
    ...
    if (!pratica || pratica.status !== 'Aguardando votacao anual') {
    ...
    console.error('Erro no GET votacao anual:', error)
