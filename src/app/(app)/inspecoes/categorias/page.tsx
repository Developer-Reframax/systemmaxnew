...
function CategoriasPage() {
  ...
  const fetchCategorias = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/inspecoes/categorias?${params}`, {
        method: 'GET',
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingCategoria 
        ? `/api/inspecoes/categorias/${editingCategoria.id}`
        : '/api/inspecoes/categorias';
  ...
  const handleDelete = async (categoria: Categoria) => {
    ...
    try {
      ...
      const response = await fetch(`/api/inspecoes/categorias/${categoria.id}`, {
        method: 'DELETE'
      });
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Gerencie as categorias de formulários de inspeção</p>
            </div>
          </div>
          <Button 
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    {categoria._count?.formularios || 0} formulários
                  </div>
