...
export default function EquipesPage() {
  ...
  const TEAMS_MANAGE_FUNC_SLUG = 'equipes-gestao'
  const canManageTeams = !!permissions?.modulos.some((modulo) =>
    modulo.funcionalidades.some((funcionalidade) => funcionalidade.slug === TEAMS_MANAGE_FUNC_SLUG)
  )
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!canManageTeams) {
      toast.error('Voce nao tem permissao para gerenciar equipes')
      return
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        {permissionsLoaded && canManageTeams && (
          <button
