...
export default function VotacaoTrimestralListaPage() {
  useAuth()
  ...
  useEffect(() => {
    const load = async () => {
      setLoading(true)
      try {
        const res = await fetch('/api/boas-praticas/votacao-trimestral', {
          method:'GET'
        })
  ...
  return (
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Votacao Trimestral</h1>
            <p className="text-gray-600">
              Boas praticas aguardando votacao no seu contrato
            </p>
          </div>
                    ...
                    <CardContent className="flex items-center justify-between p-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => router.push(`/boas-praticas/votacao-trimestral/${p.id}`)}
                        >
